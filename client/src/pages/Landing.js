...
import illustrationDesktop from '../assets/img/main-illustration-desktop@2x.jpg';
  ...
  return (
    <Container fullHeight contentCenteredMobile padding="4rem 2rem 2rem 2rem">
      <CenteredBlockWithAnimation>
        <Hider hideOnDesktop>
          <MobileIllustration src={illustrationMobile}  />
        </Hider>
        <Markdown>
          <MarketingHeadline
            as="h2"
            ...
            dangerouslySetInnerHTML={{
              __html: `Join the world’s most classy <div> online poker experience!</div>`,
            }}
          />
        </Markdown>
        ...
        <Markdown>
          <MarketingHeadline
            ...
            textCenteredOnMobile
            dangerouslySetInnerHTML={{
              __html: `You receive 30.000 free chips on registration.`,
            }}
          />
        </Markdown>
        <Wrapper>
          ...
          <Button as={Link} to="/login" large white fullWidthOnMobile>
            Login
          </Button>
        </Wrapper>
      </CenteredBlockWithAnimation>
      {/* <Hider hideOnMobile>
        <DesktopIllustration src={illustrationDesktop} />
      </Hider> */}
    </Container>
  );
};
